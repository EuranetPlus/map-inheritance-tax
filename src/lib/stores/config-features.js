export const config = {
	mapTitle: 'inheritance-gift-estate-tax-revenue', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-inheritance-tax.vercel.app/', // The url provided when deploying the map on Vercel
